...
export default function ProductShowcase() {
  return (
    <section className="relative pt-8 pb-16 md:pt-12 md:pb-24 overflow-hidden">
      {/* ── Purple gradient banner image (behind dashboard) ──── */}
      <div className="absolute bottom-0 left-0 right-0 h-[60%] z-0">
        <Image
          ...
          priority
        />
        {/* Fade top edge into the dark background */}
        ...
        <div className="relative w-full max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-3 grid-rows-2 gap-3 sm:gap-4 auto-rows-fr"
              ...
              {/* Card 2 — Top Center: circular progress ring */}
              ...
              {/* Card 3 — Top Right: avatar list (image placeholders) */}
              <div className="rounded-xl bg-[#111111] border border-white/[0.06] p-5">
                <div className="space-y-4">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="flex items-center gap-3">
                      {/* Avatar image placeholder — replace src with your images */}
              ...
              {/* Card 4 — Bottom Center: bar chart */}
              ...
              {/* Card 5 — Bottom Right: empty dark card (image placeholder) */}
